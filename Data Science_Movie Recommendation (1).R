...
movie_data <- read.csv("C:/Users/simmu/Dropbox/PC/Downloads/movies.csv",stringsAsFactors=FALSE)
rating_data <- read.csv("C:/Users/simmu/Dropbox/PC/Downloads/ratings.csv")
str(movie_data)
